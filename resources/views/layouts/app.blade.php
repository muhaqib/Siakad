            ...
            <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-transform duration-300 transform md:translate-x-0 md:sticky md:top-0 md:h-screen {{ Auth::user()->role === 'mahasiswa' ? 'hidden md:block' : '' }}"
                ...
                <div class="h-16 flex items-center justify-between px-4 logo-section" style="border-bottom: 1px solid var(--border-color);">
                    <div class="flex items-center gap-3 overflow-hidden">
                        <button @click="if(!sidebarOpen) sidebarOpen = true" :class="!sidebarOpen ? 'cursor-pointer hover:opacity-80' : 'cursor-default'" class="w-9 h-9 flex items-center justify-center flex-shrink-0 transition">
                            <img src="{{ asset('logo.PNG') }}" alt="STIT Mambaul Hikmah Logo" class="w-9 h-9 object-contain flex-shrink-0">
                        </button>
                        <div class="sidebar-logo-text min-w-0">
                            <h1 class="text-sm font-bold truncate leading-tight" style="color: var(--text-primary);">STIT Mambaul Hikmah</h1>
                            <p class="text-[11px] font-medium tracking-wide truncate" style="color: var(--text-secondary);">SIAKAD</p>
                        </div>
                    </div>
                    <!-- Desktop Toggle -->
                ...
                <nav class="p-3 space-y-1 overflow-y-auto" style="max-height: calc(100vh - 180px);">
                    ...
                    <a href="{{ url('admin/payments/dashboard') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-siakad-secondary text-sm font-medium {{ request()->is('admin/payments/dashboard') ? 'active' : '' }}">
                        <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path></svg>
                        <span class="sidebar-text">Dashboard Pembayaran</span>
                    </a>
                    <a href="{{ url('admin/payments') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-siakad-secondary text-sm font-medium {{ request()->is('admin/payments') && !request()->has('status') ? 'active' : '' }}">
                    ...
                    @if(Auth::user()->isSuperAdmin())
                    <a href="{{ url('admin/payment-types') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-siakad-secondary text-sm font-medium {{ request()->is('admin/payment-types*') ? 'active' : '' }}">
                        ...
                        <span class="sidebar-text">Pengaturan Tarif</span>
                    </a>
                    @endif
                    @endif
                    ...
                    <a href="{{ url('mahasiswa/payments') }}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-siakad-secondary text-sm font-medium {{ request()->is('mahasiswa/payments*') ? 'active' : '' }}">
                        <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>
                        <span class="sidebar-text">Pembayaran & SPP</span>
                    </a>
            ...
            <div class="flex-1 transition-all duration-300 min-w-0">
                ...
                <header class="h-16 flex items-center justify-between px-4 md:px-8 sticky top-0 z-20" style="background-color: var(--bg-card); border-bottom: 1px solid var(--border-color);">
                    <div class="flex items-center gap-3">
                        ...
                        @if(Auth::user()->role === 'mahasiswa')
                        <div class="md:hidden flex items-center gap-2 mr-1">
                            <img src="{{ asset('logo.PNG') }}" alt="STIT Mambaul Hikmah" class="w-7 h-7 object-contain">
                        </div>
                        @endif
                        ...
                        <div class="flex h-full flex-col overflow-y-scroll bg-white dark:bg-gray-800 shadow-xl pb-20 rounded-t-2xl">
                            ...
                            <div class="relative flex-1 px-4 sm:px-6">
                                <div class="grid grid-cols-3 gap-4">
                                    <a href="{{ url('mahasiswa/payments') }}" class="flex flex-col items-center justify-center p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                        ...
                                        <span class="text-xs text-center font-medium text-gray-700 dark:text-gray-300">Pembayaran</span>
                                    </a>
